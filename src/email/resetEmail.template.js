...
const emailTemplate = (url, resetId, resetDate) => {
                            ...
                            <tr style="width:100%">
                              <td align="center">
                                <a href="${process.env.CLIENT_URL}/reset/${resetDate}/${resetId}"
                                  style="font-size:16px;;display:inline-block;color:white;background-color:#2196F3;text-transform:uppercase;text-decoration:none;border-radius:30px;font-weight:800;padding:10px 40px">
                                  Reset password</a><br>
                                <br>
                                <p>
